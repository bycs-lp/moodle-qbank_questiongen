...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_database_table('qbank_questiongen_resource_cache', [
            'contenthash' => 'privacy:metadata:qbank_questiongen_resource_cache:contenthash',
            'extractedcontent' => 'privacy:metadata:qbank_questiongen_resource_cache:extractedcontent',
            'timelastaccessed' => 'privacy:metadata:qbank_questiongen_resource_cache:timelastaccessed',
            'timecreated' => 'privacy:metadata:qbank_questiongen_resource_cache:timecreated',
            'timemodified' => 'privacy:metadata:qbank_questiongen_resource_cache:timemodified',
        ], 'privacy:metadata:qbank_questiongen_resource_cache');
