...
$string['errorpresetfile'] = 'Upload a questiongen preset JSON bundle (format version 1, 1 to 100 presets, maximum 8 MiB).';
...
$string['privacy:taskdata'] = 'Background tasks contain the user ID, request IDs, source activity IDs and processing options. Legacy selection snapshots are included in export and deletion and removed from task data when processing finishes.';
