...
$string['privacy:metadata'] = 'The AI questions generator stores data related to generated question requests, presets and cached extracted resource contents.';
$string['privacy:metadata:qbank_questiongen'] = 'Stores question generation requests created by users.';
$string['privacy:metadata:qbank_questiongen:category'] = 'The question category the generated question should be created in.';
$string['privacy:metadata:qbank_questiongen:example'] = 'The example output sent with the generation request.';
$string['privacy:metadata:qbank_questiongen:instructions'] = 'The instructions text sent with the generation request.';
$string['privacy:metadata:qbank_questiongen:llmresponse'] = 'The generated raw response returned by the AI service.';
$string['privacy:metadata:qbank_questiongen:primer'] = 'The primer text sent with the generation request.';
$string['privacy:metadata:qbank_questiongen:story'] = 'The topic or content sent to the generator.';
$string['privacy:metadata:qbank_questiongen:success'] = 'The success or error state of the generation request.';
$string['privacy:metadata:qbank_questiongen:timecreated'] = 'The time when the generation request was created.';
$string['privacy:metadata:qbank_questiongen:timemodified'] = 'The time when the generation request was last updated.';
$string['privacy:metadata:qbank_questiongen:userid'] = 'The user who created the question generation request.';
$string['privacy:metadata:qbank_questiongen_preset'] = 'Stores reusable presets for question generation.';
$string['privacy:metadata:qbank_questiongen_preset:example'] = 'The preset example output.';
$string['privacy:metadata:qbank_questiongen_preset:instructions'] = 'The preset instructions text.';
$string['privacy:metadata:qbank_questiongen_preset:name'] = 'The human readable name of the preset.';
$string['privacy:metadata:qbank_questiongen_preset:primer'] = 'The preset primer text.';
$string['privacy:metadata:qbank_questiongen_preset:timecreated'] = 'The time when the preset was created.';
$string['privacy:metadata:qbank_questiongen_preset:timemodified'] = 'The time when the preset was last updated.';
$string['privacy:metadata:qbank_questiongen_resource_cache'] = 'Caches extracted text content from resources used during question generation.';
$string['privacy:metadata:qbank_questiongen_resource_cache:contenthash'] = 'The content hash of the cached file.';
$string['privacy:metadata:qbank_questiongen_resource_cache:extractedcontent'] = 'The extracted text content cached for reuse.';
$string['privacy:metadata:qbank_questiongen_resource_cache:timecreated'] = 'The time when the cache entry was created.';
$string['privacy:metadata:qbank_questiongen_resource_cache:timelastaccessed'] = 'The time when the cached content was last accessed.';
$string['privacy:metadata:qbank_questiongen_resource_cache:timemodified'] = 'The time when the cache entry was last updated.';
