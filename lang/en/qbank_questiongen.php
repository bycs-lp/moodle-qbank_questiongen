...
$string['systempromptdesc'] = 'Template for the system prompt sent to the AI. The placeholders {{primer}}, {{instructions}} and {{example}} are required and will be replaced with the corresponding values from the selected preset. All three must be present.';
...
$string['userpromptdesc'] = 'Template for the user prompt sent to the AI. The placeholder {{storyprompt}} is required and will be replaced with the generated prompt based on the selected mode and content. It must be present.';
